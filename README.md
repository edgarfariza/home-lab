# Home Lab y Automatización de Sistemas

Bienvenido al repositorio de mi **Home Lab** personal. Este proyecto es mi entorno de pruebas real para practicar **Administración de Sistemas Linux** y **Automatización**, sirviendo como complemento a mis estudios de **DAM en la UAX** y mi especialización en **Cloud Computing**.
